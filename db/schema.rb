...
ActiveRecord::Schema[7.0].define(version: 2023_09_21_213057) do
  ...
  add_foreign_key "likes", "post", column: "liked_post_id"
  add_foreign_key "likes", "user", column: "liked_user_id"
